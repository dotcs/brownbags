...
var _user$project$Main$content = function (page) {
	return _elm_lang$core$Native_List.fromArray(
		[
			(_elm_lang$core$Native_Utils.cmp(page.countResults, -1) > 0) ? A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('search-result-info')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
						...
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									...
									_elm_lang$core$Native_List.fromArray(
										[
											_elm_lang$html$Html_Attributes$class('mdlx-chip--icon')
										]),
									_elm_lang$core$Native_List.fromArray(
										[
											_debois$elm_mdl$Material_Icon$i('search')
										]))
								])),
							A2(
								...
								[
									...
									A2(
										...
										A2(
											_elm_lang$core$Basics_ops['++'],
											' results for \'',
											A2(_elm_lang$core$Basics_ops['++'], page.query, '\''))))
								]))
						]))
				])) : _elm_lang$html$Html$text(''),
			page.content
...
var _user$project$Main$Model = F4(
	function (a, b, c, d) {
		return {mdl: a, brownbags: b, query: c, searchOpen: d};
	});
...
var _user$project$Main$OpenOrClearSearch = {ctor: 'OpenOrClearSearch'};
		...
		switch (_p0.ctor) {
			...
			case 'UpdateSearchQuery':
				return A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[]));
			case 'OpenOrClearSearch':
				var focus = _elm_lang$dom$Dom$focus('brownbag-search');
				var newSearchOpen = _elm_lang$core$Basics$not(model.searchOpen);
				var newQuery = _elm_lang$core$Native_Utils.eq(newSearchOpen, true) ? model.query : '';
				var cmd = _elm_lang$core$Native_Utils.eq(newSearchOpen, true) ? A3(
					_elm_lang$core$Task$perform,
					function (_p1) {
					...
					focus) : _elm_lang$core$Platform_Cmd$none;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
...
var _user$project$Main$header = function (page) {
	return _elm_lang$core$Native_List.fromArray(
		[
			A2(
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$class('title-author')
								]),
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html$text(
									A2(_elm_lang$core$Basics_ops['++'], ' by ', page.githubUser))
								]))
						])),
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_debois$elm_mdl$Material_Button$onClick(_user$project$Main$OpenOrClearSearch)
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							A2(
							_debois$elm_mdl$Material_Icon$view,
							page.searchOpen ? 'clear' : 'search',
							_elm_lang$core$Native_List.fromArray(
								[]))
						])),
					A4(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_debois$elm_mdl$Material_Textfield$value(page.query),
							_debois$elm_mdl$Material_Textfield$onInput(_user$project$Main$UpdateSearchQuery),
							_debois$elm_mdl$Material_Textfield$onBlur(_user$project$Main$MaybeResetSearch),
							_debois$elm_mdl$Material_Options$inner(
							_elm_lang$core$Native_List.fromArray(
								[
									_debois$elm_mdl$Material_Options$id('brownbag-search')
								])),
							A2(
							_debois$elm_mdl$Material_Options$when,
							A2(_debois$elm_mdl$Material_Options$css, 'display', 'none'),
							_elm_lang$core$Basics$not(page.searchOpen)),
							...
							_elm_lang$core$Native_List.fromArray(
								[
									...
									A2(
										_elm_lang$core$Basics_ops['++'],
										'https://github.com/',
										_elm_lang$core$String$toLower(page.githubUser)))
								]),
							_elm_lang$core$Native_List.fromArray(
								[
									A5(
									...
									_elm_lang$core$Native_List.fromArray(
										[
											...
											_elm_lang$core$Native_List.fromArray(
												[
													_elm_lang$html$Html_Attributes$class('octicon octicon-mark-github'),
													_elm_lang$html$Html_Attributes$title(page.githubUser)
												]),
											_elm_lang$core$Native_List.fromArray(
												[]))
										]))
...
var _user$project$Main$cardView = function (card) {
	var actionItems = _elm_lang$core$Native_List.fromArray(
		[
			card.accessable ? A2(
			_debois$elm_mdl$Material_Layout$link,
			_elm_lang$core$Native_List.fromArray(
				[
					_debois$elm_mdl$Material_Layout$href(card.btnHref)
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A5(
...
var _user$project$Main$view = function (model) {
	...
	return A4(
		...
		_elm_lang$core$Native_List.fromArray(
			[]),
		{
			header: _user$project$Main$header(page),
			...
			main: _elm_lang$core$Native_List.fromArray(
				[
					...
					_user$project$Main$content(page))
				])
		});
};
