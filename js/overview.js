	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('mdl-card__actions mdl-card--border')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect'),
								_elm_lang$html$Html_Attributes$href(card.btnHref)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('mdl-card__menu')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text('check circle')
									]))
							]))
					])) : _elm_lang$html$Html$text('')
			]));
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$class('mdl-navigation mdl-layout--large-screen-only')
									]),
								_elm_lang$core$Native_List.fromArray(
									[
										A2(
					...
					A2(
						...
						function (card) {
							return A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$class('mdl-cell mdl-cell--4-col')
									]),
								_elm_lang$core$Native_List.fromArray(
									[card]));
						},
...
var _user$project$Main$MsgNothing = {ctor: 'MsgNothing'};
